        ...
        <div class="col-md-3 col-sm-12">
            ...
            <div id="my-nav">
                <ul class="nav nav-list">
                    ...
                    <li>
                        <a href="animations.html"> Animations <span class="v"><i class="fa fa-external-link-square"></i></span></a>
                    </li>
                    <li>
                        <a href="themes.html"> Themes <span class="v"><i class="fa fa-external-link-square"></i></span></a>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-list">
                            ...
                            <li>
                                <a href="#api-button-settext"> .&lt;buttonName&gt;.setText()</a>
                            </li>
                            <li>
                                <a href="#api-button-addclass"> .&lt;buttonName&gt;.addClass()</a>
                            </li>
                            <li>
                                <a href="#api-button-removeclass"> .&lt;buttonName&gt;.removeClass()</a>
                            </li>
                            <li>
                                <a href="#api-button-disable"> .&lt;buttonName&gt;.disable()</a>
                            </li>
                            <li>
                                <a href="#api-button-enable"> .&lt;buttonName&gt;.enable()</a>
                            </li>
                            <li>
                                <a href="#api-button-hide"> .&lt;buttonName&gt;.hide()</a>
                            </li>
                            <li>
                                <a href="#api-button-show"> .&lt;buttonName&gt;.show()</a>
                            </li>
                            <li>
                    ...
                    <!--<a href="https://craftpip.github.io/angular-confirm" target="_blank">-->
                        <div class="alert alert-info">
                            <img src="https://craftpip.github.io/angular-confirm/angular-confirm.png"
                                 ...
                                 alt="">
                            <p>
                                <strong>Using Angular?</strong>
                                try out angular-confirm, its a complete re-write of jquery-confirm, and has all the
                                features currently in jquery-confirm.

                            </p>
                            <a href="https://craftpip.github.io/angular-confirm"
                               target="_blank"
                               class="btn btn-info pull-right">angular-confirm</a>
                    ...
                    <script type="text/javascript">
                        $('.example3').on('click', function () {
                            $.confirm({
                                buttons: {
                                    something: function () {
                                        // here the button key 'something' will be used as the text.
            ...
            return false;
                    ...
                    <script type="text/javascript">
                        $('.example3-1-a-f-1').on('click', function () {
                            $.confirm({
                                content: 'Click on the buttons to test it out, <br>Click on the close icon to close the modal',
                                closeIcon: true, // to close the modal
                                buttons: {
                                    buttonA: {
                                        text: 'button a',
                                        action: function () {
...
$.confirm({
    ...
    onAction: function () {}
            ...
            <section id="options">
                ...
                <div class="section">
                    <p>Options, their defaults, possibilities and explainations.</p>
        ...
        // this === jc
                ...
                <div>
                    <h4 id="api-setcontent">
                        <code>jc.setContent(string)</code>
                    </h4>
                ...
                <div>
                    <h4 id="api-setcontentprepend">
                        <code>jc.setContentPrepend(string)</code>
                    </h4>
                ...
                <div>
                    <h4 id="api-setcontentappend">
                        <code>jc.setContentAppend(string)</code>
                    </h4>
                    <p><kbd>function</kbd></p>
                    <div class="section">
                ...
                <div>
                    <h4 id="api-button-settext">
                        <code>jc.&lt;buttonName&gt;.setText(text)</code>
                    </h4>
                    <p><kbd>function</kbd></p>
                    <div class="section">
                ...
                <div>
                    <h4 id="api-button-addclass">
                        <code>jc.&lt;buttonName&gt;.addClass(text)</code>
                    </h4>
                    <p><kbd>function</kbd></p>
                    <div class="section">
                ...
                <div>
                    <h4 id="api-button-removeclass">
                        <code>jc.&lt;buttonName&gt;.removeClass(text)</code>
                    </h4>
                    <p><kbd>function</kbd></p>
                    <div class="section">
                ...
                <div>
                    <h4 id="api-button-disable">
                        <code>jc.&lt;buttonName&gt;.disable()</code>
                    </h4>
                    <p><kbd>function</kbd></p>
                    <div class="section">
                ...
                <div>
                    <h4 id="api-button-enable">
                        <code>jc.&lt;buttonName&gt;.enable()</code>
                    </h4>
                    <p><kbd>function</kbd></p>
                    <div class="section">
                ...
                <div>
                    <h4 id="api-seticon">
                        <code>jc.setIcon(iconClass)</code>
                    </h4>
                    <p><kbd>function</kbd></p>
                    <div class="section">
                        <p>Sets the icon and overwrites jc.icon</p>
                    </div>
                </div>
                <div>
                    <h4 id="api-close">
