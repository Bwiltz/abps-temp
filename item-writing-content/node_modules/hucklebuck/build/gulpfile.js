...
gulp.task('manifest', tasks.manifest(config));

gulp.task('tincan', tasks.tincan(config));

gulp.task(
  'polyfills',
  [ 'tincan', 'indexhtml', 'manifest' ],
  tasks.polyfills(config)
);

gulp.task('bundle', [ 'wat', 'polyfills' ], tasks.bundle(config));
